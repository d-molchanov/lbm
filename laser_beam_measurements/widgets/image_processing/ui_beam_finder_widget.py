...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.roi_controls_group_box.setMinimumSize(QSize(120, 125))
        self.roi_controls_group_box.setMaximumSize(QSize(120, 125))
        self.roi_x_control = ROIControl(self.roi_controls_group_box)
        self.roi_x_control.setGeometry(QRect(10, 25, 100, 20))
        self.roi_y_control = ROIControl(self.roi_controls_group_box)
        self.roi_y_control.setGeometry(QRect(10, 50, 100, 20))
        self.roi_w_control = ROIControl(self.roi_controls_group_box)
        self.roi_w_control.setGeometry(QRect(10, 75, 100, 20))
        self.roi_h_control = ROIControl(self.roi_controls_group_box)
        self.roi_h_control.setGeometry(QRect(10, 100, 100, 20))
