...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.show_display_button.setIconSize(QSize(16, 16))
        ...
        self.save_image_button.setIconSize(QSize(16, 16))
        ...
        self.beam_analyzing_section_label = QLabel(self.buttonsGroupBox)
        self.beam_analyzing_section_label.setObjectName(u"beam_analyzing_section_label")
        sizePolicy1.setHeightForWidth(self.beam_analyzing_section_label.sizePolicy().hasHeightForWidth())
        self.beam_analyzing_section_label.setSizePolicy(sizePolicy1)
        self.beam_analyzing_section_label.setMinimumSize(QSize(30, 30))
        self.beam_analyzing_section_label.setMaximumSize(QSize(30, 30))

        self.horizontalLayout.addWidget(self.beam_analyzing_section_label)
        ...
        self.show_beam_finder.setIconSize(QSize(16, 16))
        ...
        self.show_beam_profiler.setIconSize(QSize(16, 16))
...
#if QT_CONFIG(tooltip)
        self.beam_analyzing_section_label.setToolTip(QCoreApplication.translate("MainWindow", u"Beam Analyzing Section", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.beam_analyzing_section_label.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.beam_analyzing_section_label.setText("")
#if QT_CONFIG(tooltip)
